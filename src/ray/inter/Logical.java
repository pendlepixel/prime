...
/**
 * @DESCRIPTION: 逻辑运算的相关类，And,Or,Not,Rel的父类，为他们提供一些常见功能。
*/
public class Logical extends Expr {
    ...
    */
    ...
    /**
    * @DESCRIPTION: 逻辑运算的运算分量类型检查
    * @PARAM[IN]: p1, 第一个运算分量的类型
    * @PARAM[IN]: p2, 第二个运算分量的类型
    * @RETURN: Type类型，如果p1和p2都是Type.Bool，则返回Type.Bool；否则，返回null
    */
